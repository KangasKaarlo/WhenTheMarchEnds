...
import fi.tuni.tamk.WTME.utils.Card;
import fi.tuni.tamk.WTME.utils.Deck;
import fi.tuni.tamk.WTME.utils.GameState;
...
public class CoreGameplayLoop implements Screen {
    ...
    private fi.tuni.tamk.WTME.utils.Deck commonDeck;
    private fi.tuni.tamk.WTME.utils.Deck endConditionDeck;
    private fi.tuni.tamk.WTME.utils.Deck storyDeck;
    ...
    public CoreGameplayLoop(final Main host) {
        this.host = host;
        batch = host.batch;
        commonDeck = new fi.tuni.tamk.WTME.utils.Deck(Gdx.files.internal("deckJson.txt"));
        endConditionDeck = new fi.tuni.tamk.WTME.utils.Deck(Gdx.files.internal("endConditionDeck.txt"));
        ...
        if (Gdx.files.local("savedGameState.txt").length() == 0) {
            ...
            Gson gson = new Gson();
            fi.tuni.tamk.WTME.utils.GameState savedGame;
            String saveJsonString = Gdx.files.local("savedGameState.txt").readString();
            savedGame= gson.fromJson(saveJsonString, fi.tuni.tamk.WTME.utils.GameState.class);
    ...
    public void saveGame() {
        Gson gson = new Gson();
        fi.tuni.tamk.WTME.utils.GameState gameStateToBeSaved = new GameState(social, sleep, hunger, duty,
